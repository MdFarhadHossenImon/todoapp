...
import 'package:project01/data/models/task_status_model.dart';
import 'package:project01/data/services/network_caller.dart';
import 'package:project01/data/utils/urls.dart';
import 'package:project01/ui/controllers/new_task_list_controller.dart';
import 'package:project01/ui/screens/add_new_task_screen.dart';
...
import 'package:project01/ui/widgets/task_summary_card.dart';
...
class _NewTaskScreenState extends State<NewTaskScreen> {
  ...
  Future<void> _getNewTaskList() async {
    ...
    if (result== false) {
      showSnackBarMessage(context,_newTaskListController.errorMassage!, true);
    }
  }
